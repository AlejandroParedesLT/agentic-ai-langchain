...
#     calculator: str  # Calculator decision
...
SERVICE_ALIASES ={
    "arxiv": os.getenv('arxiv', "http://arxiv:8000"),
    "calculator": os.getenv('calculator', "http://calculator:8000"),
    "coding": os.getenv('coding', "http://coding:8000"),
    "dataAnalysis": os.getenv('dataAnalysis', "http://dataAnalysis:8000"),
    "websearch":os.getenv('websearch', "http://websearch:8000"),
    "vectordb":os.getenv('vectordb', "http://vectordb:8000"),

    "documentGrader": os.getenv('documentGrader', "http://documentGrader:8000"),
    "routers":os.getenv('routers', "http://routers:8000"),
    "hallucinationGrader":os.getenv('hallucinationGrader', "http://hallucinationGrader:8000"),
    "responseGenerator":os.getenv('responseGenerator', "http://responseGenerator:8000"),
}
